...
UPDATE [Usuarios] SET [PasswordHash] = 0x495CFAAC694B56968A4200907A06866B6363AA649ED325BD7E9C8B23EEABACB901EC8388BE534F36478A26D087718B34A36F7F87C17B34AC6E4B0E93BCF8EA3E, [PasswordSalt] = , [Username] = N'UsuarioAdmin'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220506012455_MigracaoPerfil', N'5.0.15');
GO
...
EXEC sp_rename N'[Usuarios].[Foto]', N'FotoPersonagem', N'COLUMN';
GO
...
UPDATE [Usuarios] SET [PasswordHash] = 0x06D011F243A9AD40715D2778F4173D33060A85AE70B5A01A8381FEC9711F69B9241F24AF1ACA353F114780680701110518344C81A1503F065CC866DC1874FD21, [PasswordSalt] = 
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220512234004_MigracaoDisputas', N'5.0.15');
GO
